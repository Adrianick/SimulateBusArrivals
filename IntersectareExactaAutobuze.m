function [probabilitateaIntersectieiExacte] = IntersectareExactaAutobuze(n, semafor1, semafor2)
    ...
    probabilitateaIntersectieiExacte = sum(ecuatia == 0) / n; % de cate ori traseul1 - traseul2 a rezultat 0 secunde 
